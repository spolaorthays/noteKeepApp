...
import kotlinx.android.synthetic.main.activity_itens.*

class ItensActivity : AppCompatActivity() {

    private lateinit var appBarConfiguration: AppBarConfiguration

    //Utilizando by lazy, eu atraso a criação dessa propriedade, para evitar que ela seja criada antes do próprio onCreate
